        ...
        {formSubmitted && (
          <div className="mb-8 bg-gradient-to-r from-success/20 to-success/10 border border-success/30 rounded-2xl p-8 text-center animate-fade-in">
            ...
            <p className="text-gray-300">
              An attorney will contact you within 15 minutes to confirm your appointment.
            </p>
          </div>
        )}
            ...
            <div className="relative bg-gradient-to-br from-secondary-900 to-black rounded-2xl p-8 border border-primary/30 max-w-md w-full shadow-2xl">
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:border-primary focus:outline-none">
                ...
                <button 
                  type="submit"
                  className="w-full py-3 bg-gradient-primary text-white rounded-lg font-semibold hover:opacity-90 transition-all flex items-center justify-center gap-2"
                >
